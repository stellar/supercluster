...
let MakeCatchupSets (options: CatchupMissionOptions) =
    ...
    let newNodeOptions = { CoreSetOptions.GetDefault options.catchupImage with nodeCount = 1; quorumSet = CoreSetQuorum(CoreSetName "generator"); accelerateTime = true; initialization = CoreSetInitialization.DefaultNoForceSCP }
    ...
    let minimal2Options = { minimal1Options with quorumSet = CoreSetQuorum(CoreSetName "minimal1"); image = options.catchupImage }
    ...
    let complete2Options = { complete1Options with quorumSet = CoreSetQuorum(CoreSetName "complete1"); image = options.catchupImage }
    ...
    let recent2Options = { recent1Options with quorumSet = CoreSetQuorum(CoreSetName "recent1"); image = options.catchupImage }
    ...
    let minimal3Options = { minimal1Options with quorumSet = CoreSetQuorum(CoreSetName "complete1"); image = options.catchupImage }
    ...
    let recent3Options = { recent1Options with quorumSet = CoreSetQuorum(CoreSetName "complete1"); image = options.catchupImage }
